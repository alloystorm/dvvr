...
PMX 模型自带物理组件定义，因此开箱即用。您可以在 [PMX物理设置](features/pmx_physics) 中自定义和微调 PMX 模型的物理行为。
...
- [分离物体](features/detach_object) — 释放一个骨骼或物体，使其可以作为独立部件脱落。当这些部件没有独立的材质供您使用透明度隐藏时，这一点非常有用。
