...
| <img src="/images/icon/ic_palette.png" alt="palette icon"/> **身体画**| | 
| ├─ ☑ 绘画侧面| 两者 | 两者, 前面, 背面, 
| ├─ > 纹理| **[无]** | [无], [纹身],  |
| ├─ ⊖ 刷子大小| [0.2] (0 ~ 1) | 
| ├─ ⊖ 刷子旋转| [0] (-180 ~ 180) | 
...
| ├─ 保存绘图|| 
| └─ > 加载绘图| **[无]** | [无],  |
| <img src="/images/icon/ic_hex.png" alt="hex icon"/> **形状和图案**| | 
...
| ├─ ⊖ 投影半径| [0.2] (0 ~ 1) | 
| └─ ⊖ 旋转| [0] (-90 ~ 90) | 
| <img src="/images/icon/ic_texture.png" alt="texture icon"/> **基础表面**| | 
| ├─ ⊖ 光泽| [0.5] (0 ~ 1) | 
| ├─ ⊖ 金属质感| [0] (0 ~ 1) | 
| ├─ ⊖ 凹凸| [0.2] (0 ~ 1) | 
| ├─ ⊖ 发光| [0] (0 ~ 10) | 
...
| <img src="/images/icon/ic_texture.png" alt="texture icon"/> **表面图案**| | 
| ├─ ⊖ 光泽| [0.9] (0 ~ 1) | 
| ├─ ⊖ 金属质感| [0] (0 ~ 1) | 
| ├─ ⊖ 凹凸| [0] (0 ~ 1) | 
| ├─ ⊖ 发光| [0] (0 ~ 10) | 
...
| <img src="/images/icon/ic_texture.png" alt="texture icon"/> **表面边框**| | 
| ├─ ⊖ 光泽| [0.5] (0 ~ 1) | 
| ├─ ⊖ 金属质感| [0] (0 ~ 1) | 
| ├─ ⊖ 凹凸| [0.2] (0 ~ 1) | 
| ├─ ⊖ 发光| [0] (0 ~ 10) | 
