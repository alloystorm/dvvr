...
## 오디오 타이밍 개선 (v2026.2)  
DanceXR 2026.2는 오디오 타이밍 동기화를 개선하여 오디오/동작 비동기화를 더욱 줄이고 프레임 레이트 변동으로 인한 가끔 발생하는 끊김을 제거합니다. v2026.3에서는 프레임 레이트 변동이 큰 경우 오디오 시간 매끄러움으로 인해 발생할 수 있는 진동 문제를 해결하는 추가 수정이 포함됩니다.