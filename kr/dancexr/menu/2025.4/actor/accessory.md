...
| :--- | --- | :--- |
| <img src="/images/icon/ic_check_off.png" alt="check off icon"/> <b>폴</b></nobr>| | 
...
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 객체 길이</nobr>| [3] (0 ~ 5) | 
...
| ├─<img src="/images/icon/ic_check_off.png" alt="check off icon"/> 잡기 포즈</nobr>| [OFF] | 부착물에 있을 때 자동으로 손 포즈를 잡기 자세로 변경
...
| └─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 손 동작</nobr>| [0] (-1 ~ 1) | 부착물 모션에 따라 손을 이동
| <img src="/images/icon/ic_check_off.png" alt="check off icon"/> 대칭 손</nobr>| [OFF] | 
...
| ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 잡기 포즈</nobr>| [ON] | 부착물에 있을 때 자동으로 손 포즈를 잡기 자세로 변경
| └─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 손 동작</nobr>| [0] (-1 ~ 1) | 부착물 모션에 따라 손을 이동
| <img src="/images/icon/ic_check_off.png" alt="check off icon"/> <b>가슴</b></nobr>| | 
| ├─<img src="/images/icon/ic_check_off.png" alt="check off icon"/> 활성화</nobr>| [OFF] | 
| ├─<img src="/images/icon/ic_chevron.png" alt="chevron icon"/> 모델</nobr>| **[기둥]** | [기둥],  |
| ├─<img src="/images/icon/ic_tune.png" alt="tune icon"/> <b>앵커 오프셋</b></nobr>| | Set the anchor position for the attachment to attach to
| │ ├─ <b>위치</b></nobr>|| 
...
| ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 잡기 포즈</nobr>| [ON] | 부착물에 있을 때 자동으로 손 포즈를 잡기 자세로 변경
| └─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 손 동작</nobr>| [0] (-1 ~ 1) | 부착물 모션에 따라 손을 이동
| <img src="/images/icon/ic_check_off.png" alt="check off icon"/> <b>머리</b></nobr>| | 
| ├─<img src="/images/icon/ic_check_off.png" alt="check off icon"/> 활성화</nobr>| [OFF] | 
| ├─<img src="/images/icon/ic_chevron.png" alt="chevron icon"/> 모델</nobr>| **[기둥]** | [기둥],  |
| ├─<img src="/images/icon/ic_tune.png" alt="tune icon"/> <b>앵커 오프셋</b></nobr>| | Set the anchor position for the attachment to attach to
| │ ├─ <b>위치</b></nobr>|| 
...
| ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 잡기 포즈</nobr>| [ON] | 부착물에 있을 때 자동으로 손 포즈를 잡기 자세로 변경
| └─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 손 동작</nobr>| [0] (-1 ~ 1) | 부착물 모션에 따라 손을 이동
| <img src="/images/icon/ic_check_off.png" alt="check off icon"/> <b>왼발</b></nobr>| | 
| ├─<img src="/images/icon/ic_check_off.png" alt="check off icon"/> 활성화</nobr>| [OFF] | 
| ├─<img src="/images/icon/ic_chevron.png" alt="chevron icon"/> 모델</nobr>| **[기둥]** | [기둥],  |
| ├─<img src="/images/icon/ic_tune.png" alt="tune icon"/> <b>앵커 오프셋</b></nobr>| | Set the anchor position for the attachment to attach to
| │ ├─ <b>위치</b></nobr>|| 
...
| ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 잡기 포즈</nobr>| [ON] | 부착물에 있을 때 자동으로 손 포즈를 잡기 자세로 변경
| └─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 손 동작</nobr>| [0] (-1 ~ 1) | 부착물 모션에 따라 손을 이동
| <img src="/images/icon/ic_check_off.png" alt="check off icon"/> 대칭 발</nobr>| [OFF] | 
| <img src="/images/icon/ic_check_off.png" alt="check off icon"/> <b>오른발</b></nobr>| | 
| ├─<img src="/images/icon/ic_check_off.png" alt="check off icon"/> 활성화</nobr>| [OFF] | 
| ├─<img src="/images/icon/ic_chevron.png" alt="chevron icon"/> 모델</nobr>| **[기둥]** | [기둥],  |
| ├─<img src="/images/icon/ic_tune.png" alt="tune icon"/> <b>앵커 오프셋</b></nobr>| | Set the anchor position for the attachment to attach to
| │ ├─ <b>위치</b></nobr>|| 
