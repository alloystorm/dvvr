...
| :--- | --- | :--- |
| 이전 씬 로드 | OFF | 시작 시 마지막 씬 자동 로드0/7/False
| VR에서 데스크톱 창 차단 | ON | VR 모드에서 데스크톱 창 차단1/7/False
| 저장된 태그 복구 | OFF | 내용 캐시가 재구성되거나 손상된 경우 저장된 설정에서 태그 복구 시도2/7/False
| DDS 압축 전환 | ON | 압축된 DDS 텍스처 전환3/7/False
| DDS 비압축 전환 | OFF | 비압축된 DDS 텍스처 전환4/7/False
| **VR 손** | | 5/7/False
| ├ 손 보이기 | ON | 0/7/False
| ├ 그림자 생성 | OFF | 1/7/False
