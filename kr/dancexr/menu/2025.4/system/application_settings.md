...
| :--- | --- | :--- |
|<nobr>![check_off icon](/images/icon/ic_check_off.png) 이전 씬 로드</nobr>| [OFF] | 시작 시 마지막 씬 자동 로드
|<nobr>![check_on icon](/images/icon/ic_check_on.png) VR에서 데스크톱 창 차단</nobr>| [ON] | VR 모드에서 데스크톱 창 차단
|<nobr>![check_off icon](/images/icon/ic_check_off.png) 저장된 태그 복구</nobr>| [OFF] | 내용 캐시가 재구성되거나 손상된 경우 저장된 설정에서 태그 복구 시도
|<nobr>![check_on icon](/images/icon/ic_check_on.png) DDS 압축 전환</nobr>| [ON] | 압축된 DDS 텍스처 전환
|<nobr>![check_off icon](/images/icon/ic_check_off.png) DDS 비압축 전환</nobr>| [OFF] | 비압축된 DDS 텍스처 전환
|<nobr>![hand icon](/images/icon/ic_hand.png) <b>VR 손</b></nobr>| | 
|<nobr>├&nbsp;![check_on icon](/images/icon/ic_check_on.png) 손 보이기</nobr>| [ON] | 
...
|<nobr>├&nbsp;![tune icon](/images/icon/ic_tune.png) <b>손 방향</b></nobr>| | 
|<nobr>│&nbsp;├&nbsp; <b>오프셋</b></nobr>|| 
...
|<nobr>│&nbsp;├&nbsp;![slider icon](/images/icon/ic_slider.png) 회전</nobr>| [45] (-90 ~ 90) | 
|<nobr>│&nbsp;└&nbsp; 포인터 업데이트</nobr>|| 
|<nobr>├&nbsp;![chevron icon](/images/icon/ic_chevron.png) 왼손 포즈</nobr>| **자동** | 자동, (Palm Fingers Apart), (Palm Fingers Together), (Fist), (Victory), (Okay), (Hold), (Vulcan), (Horn), 점, (Middle Finger), (Thumb Up), (Grab),  |
|<nobr>├&nbsp;![check_off icon](/images/icon/ic_check_off.png) <b>왼손 액세서리</b></nobr>| | 
...
|<nobr>├&nbsp;![chevron icon](/images/icon/ic_chevron.png) 오른손 포즈</nobr>| **자동** | 자동, (Palm Fingers Apart), (Palm Fingers Together), (Fist), (Victory), (Okay), (Hold), (Vulcan), (Horn), 점, (Middle Finger), (Thumb Up), (Grab),  |
|<nobr>└&nbsp;![check_off icon](/images/icon/ic_check_off.png) <b>오른손 액세서리</b></nobr>| | 
|<nobr>&nbsp;&nbsp;├&nbsp;![check_off icon](/images/icon/ic_check_off.png) 활성화</nobr>| [OFF] | 
|<nobr>&nbsp;&nbsp;├&nbsp;![chevron icon](/images/icon/ic_chevron.png) 모델</nobr>| **[기둥]** | [기둥],  |
|<nobr>&nbsp;&nbsp;├&nbsp;![tune icon](/images/icon/ic_tune.png) <b>앵커 오프셋</b></nobr>| | Set the anchor position for the attachment to attach to
|<nobr>&nbsp;&nbsp;│&nbsp;├&nbsp; <b>위치</b></nobr>|| 
...
|<nobr>&nbsp;&nbsp;├&nbsp;![check_on icon](/images/icon/ic_check_on.png) 잡기 포즈</nobr>| [ON] | 부착물에 있을 때 자동으로 손 포즈를 잡기 자세로 변경
|<nobr>&nbsp;&nbsp;└&nbsp;![slider icon](/images/icon/ic_slider.png) 손 동작</nobr>| [0] (-1 ~ 1) | 부착물 모션에 따라 손을 이동
|<nobr>![chevron icon](/images/icon/ic_chevron.png) 기즈모 3차 축</nobr>| **회전** | 회전, 깊이,  |
|<nobr>![check_on icon](/images/icon/ic_check_on.png) 번역된 이름 사용</nobr>| [ON] | 
