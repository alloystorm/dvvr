...
| :--- | --- | :--- |
|<nobr> ![radio_on icon](/images/icon/ic_radio_on.png)  [프리플라이 카메라]</nobr>|| 
|<nobr>└&nbsp; ![setting icon](/images/icon/ic_setting.png)  <b>[프리플라이 카메라]</b></nobr>| | 
...
|<nobr> ![radio_off icon](/images/icon/ic_radio_off.png)  [오르빗 카메라]</nobr>|| 
|<nobr>└&nbsp; ![setting icon](/images/icon/ic_setting.png)  <b>[오르빗 카메라]</b></nobr>| | 
|<nobr>&nbsp;&nbsp;├&nbsp; ![chevron icon](/images/icon/ic_chevron.png)  타겟 선택</nobr>| **자동** | 자동, 선택됨, 그룹, 회전, 회전 + 그룹, 무대 중앙,  |
|<nobr>&nbsp;&nbsp;├&nbsp; ![chevron icon](/images/icon/ic_chevron.png)  트래킹 모드</nobr>| **센터** | 센터, 머리, 가슴,  |
|<nobr>&nbsp;&nbsp;├&nbsp; ![slider icon](/images/icon/ic_slider.png)  타겟 부드럽게 만들기</nobr>| [0.5] (0 ~ 2) | 
|<nobr>&nbsp;&nbsp;├&nbsp; ![slider icon](/images/icon/ic_slider.png)  예측</nobr>| [1] (0 ~ 2) | 부드러움으로 인한 지연을 줄이기 위해 타겟의 위치를 예측
...
|<nobr> ![radio_off icon](/images/icon/ic_radio_off.png)  [오토 캠]</nobr>|| 
|<nobr>└&nbsp; ![setting icon](/images/icon/ic_setting.png)  <b>[오토 캠]</b></nobr>| | 
|<nobr>&nbsp;&nbsp;├&nbsp; ![chevron icon](/images/icon/ic_chevron.png)  타겟 선택</nobr>| **자동** | 자동, 선택됨, 그룹, 회전, 회전 + 그룹, 무대 중앙,  |
|<nobr>&nbsp;&nbsp;├&nbsp; ![chevron icon](/images/icon/ic_chevron.png)  트래킹 모드</nobr>| **센터** | 센터, 머리, 가슴,  |
|<nobr>&nbsp;&nbsp;├&nbsp; ![slider icon](/images/icon/ic_slider.png)  타겟 부드럽게 만들기</nobr>| [0.5] (0 ~ 2) | 
|<nobr>&nbsp;&nbsp;├&nbsp; ![slider icon](/images/icon/ic_slider.png)  예측</nobr>| [1] (0 ~ 2) | 부드러움으로 인한 지연을 줄이기 위해 타겟의 위치를 예측
...
|<nobr>&nbsp;&nbsp;└&nbsp; ![list icon](/images/icon/ic_list.png)  프리셋</nobr>| **기본값 (초기화)** | 기본값 (초기화), (Preset 1),  |
|<nobr> ![radio_off icon](/images/icon/ic_radio_off.png)  [롱 테이크]</nobr>|| 
|<nobr>└&nbsp; ![setting icon](/images/icon/ic_setting.png)  <b>[롱 테이크]</b></nobr>| | 
|<nobr>&nbsp;&nbsp;├&nbsp; ![chevron icon](/images/icon/ic_chevron.png)  타겟 선택</nobr>| **자동** | 자동, 선택됨, 그룹, 회전, 회전 + 그룹, 무대 중앙,  |
|<nobr>&nbsp;&nbsp;├&nbsp; ![chevron icon](/images/icon/ic_chevron.png)  트래킹 모드</nobr>| **센터** | 센터, 머리, 가슴,  |
|<nobr>&nbsp;&nbsp;├&nbsp; ![slider icon](/images/icon/ic_slider.png)  타겟 부드럽게 만들기</nobr>| [0.5] (0 ~ 2) | 
|<nobr>&nbsp;&nbsp;├&nbsp; ![slider icon](/images/icon/ic_slider.png)  예측</nobr>| [1] (0 ~ 2) | 부드러움으로 인한 지연을 줄이기 위해 타겟의 위치를 예측
...
|<nobr> ![radio_off icon](/images/icon/ic_radio_off.png)  [1인칭]</nobr>|| 
|<nobr>└&nbsp; ![setting icon](/images/icon/ic_setting.png)  <b>[1인칭]</b></nobr>| | 
...
|<nobr>&nbsp;&nbsp;└&nbsp; 재중심화</nobr>|| 
|<nobr> ![radio_off icon](/images/icon/ic_radio_off.png)  [고정 카메라]</nobr>|| 
|<nobr>└&nbsp; ![setting icon](/images/icon/ic_setting.png)  <b>[고정 카메라]</b></nobr>| | 
|<nobr>&nbsp;&nbsp;├&nbsp; ![chevron icon](/images/icon/ic_chevron.png)  타겟 선택</nobr>| **자동** | 자동, 선택됨, 그룹, 회전, 회전 + 그룹, 무대 중앙,  |
|<nobr>&nbsp;&nbsp;├&nbsp; ![chevron icon](/images/icon/ic_chevron.png)  트래킹 모드</nobr>| **센터** | 센터, 머리, 가슴,  |
|<nobr>&nbsp;&nbsp;├&nbsp; ![slider icon](/images/icon/ic_slider.png)  타겟 부드럽게 만들기</nobr>| [0.5] (0 ~ 2) | 
|<nobr>&nbsp;&nbsp;├&nbsp; ![slider icon](/images/icon/ic_slider.png)  예측</nobr>| [1] (0 ~ 2) | 부드러움으로 인한 지연을 줄이기 위해 타겟의 위치를 예측
