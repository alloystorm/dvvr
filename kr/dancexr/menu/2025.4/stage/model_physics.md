...
|- 질량 중심 | 자동, **제로**,  | 질량 중심을 제로로 설정하거나 각 충돌체의 위치와 크기에 따라 자동 설정
...
| 2단계 해결 | OFF | 
|
| 프리셋 | **가슴**, 엉덩이, 다리, (tina), (预设1), (预设2),  |  |
|
| 소프트바디 전용 | OFF | 물리 조인트를 비활성화하고 소프트바디 입자만 사용합니다.
| 프리셋 | **기본값 (초기화)**, (Preset 1), (Preset 2), (Preset 3), (tina), (预设1), (预设2),  |  |
|
|**스커트 물리**<sup>[PRO]</sup> | | 
...
| 기본 그룹 || 
| 뼈 선택 || 
| 정렬 | **최단 경로**, 원형, 선형, 정렬 없음,  | 측면 연결을 만들 때 사용되는 정렬 방법을 설정합니다. |
...
| 기본 그룹 설정 사용 | ON | 
|
| 프리셋 | **기본값 (초기화)**, (hurrah), (nyotengu cheongsam), (nyo birthday), (Preset 1), (Preset 2), (Preset 3), (Preset 4), (Preset 5), (Preset 6), (预设1),  |  |
|
|**헤어 물리** | | 
...
|- 콜라이더 길이 | [0.9] (0 ~ 1) | 
|- 앵커 위치 | [0] (0 ~ 1) | 조인트 생성 시 앵커 위치 선택. 0 = 부모 본에 앵커, 1 = 자식 본에 앵커
| 프리셋 | **기본값 (초기화)**, (momiji bob), (Preset 1),  |  |
|
|**드리블 물리** | | 
