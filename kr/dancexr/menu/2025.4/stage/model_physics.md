...
| :--- | --- | :--- |
| <img src="/images/icon/ic_check_off.png" alt="check off icon"/> PMX 물리 비활성화</nobr>| [OFF] | XPS 도구 사용을 위해 PMX 물리 비활성화
| <img src="/images/icon/ic_check_on.png" alt="check on icon"/> 제약 감소</nobr>| [ON] | 보다 부드러운 시뮬레이션을 허용하기 위해 제약을 줄이는 실험적 설정 사용
| <img src="/images/icon/ic_tune.png" alt="tune icon"/> <b>충돌</b></nobr>| | 
| ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 정적 포함</nobr>| [ON] | 
| ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 정적 배타</nobr>| [ON] | 
| ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 동적 포함</nobr>| [ON] | 
| └─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 동적 배타</nobr>| [ON] | 
| <img src="/images/icon/ic_tune.png" alt="tune icon"/> <b>선형이동</b></nobr>| | Settings for linear movements
| ├─<img src="/images/icon/ic_toggle_on.png" alt="toggle on icon"/> 제약</nobr>| 자동 | 자동, 제한됨, 잠김, 자유, 
| ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 0 제한 고정</nobr>| [ON] | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 최소 스프링 힘</nobr>| [5] (0 ~ 15) | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 최대 제한</nobr>| [0.05] (0.05 ~ 0.1) | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 튀는 정도</nobr>| [0.5] (0 ~ 1) | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 접촉 거리</nobr>| [0.5] (0 ~ 1) | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 감쇠</nobr>| [0.05] (0 ~ 1) | 
| └─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 드래그</nobr>| [0.15] (0 ~ 1) | 
| <img src="/images/icon/ic_tune.png" alt="tune icon"/> <b>각이동</b></nobr>| | Settings for angular movements
| ├─<img src="/images/icon/ic_toggle_on.png" alt="toggle on icon"/> 제약</nobr>| 자동 | 자동, 제한됨, 잠김, 자유, 
| ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 0 제한 고정</nobr>| [ON] | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 최소 스프링 힘</nobr>| [5] (0 ~ 15) | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 최대 제한</nobr>| [90] (3 ~ 90) | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 튀는 정도</nobr>| [0.5] (0 ~ 1) | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 접촉 거리</nobr>| [0.5] (0 ~ 1) | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 감쇠</nobr>| [0.05] (0 ~ 1) | 
| └─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 드래그</nobr>| [0.15] (0 ~ 1) | 
| <img src="/images/icon/ic_check_on.png" alt="check on icon"/> <b>선형운전</b></nobr>| | Apply linear drive
| ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 활성화</nobr>| [ON] | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 스프링 힘</nobr>| [3] (0 ~ 5) | 
| └─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 감쇠</nobr>| [0.1] (0 ~ 1) | 
| <img src="/images/icon/ic_check_on.png" alt="check on icon"/> <b>각운전</b></nobr>| | Apply angular drive
| ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 활성화</nobr>| [ON] | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 스프링 힘</nobr>| [0.1] (0 ~ 5) | 
| └─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 감쇠</nobr>| [0.1] (0 ~ 1) | 
| <img src="/images/icon/ic_tune.png" alt="tune icon"/> <b>선형운동</b></nobr>| | Settings for linear motion
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 단단함</nobr>| [0] (-1 ~ 1) | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 주 동력</nobr>| [5] (0 ~ 8) | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/>  두 번째 동력</nobr>| [3] (0 ~ 8) | 
| ├─<img src="/images/icon/ic_toggle_on.png" alt="toggle on icon"/> 목표 위치</nobr>| 제로 | 제로, 센터, 최소, 최대, 
| ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 가능할 때 잠금</nobr>| [ON] | 
| ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 가속 모드</nobr>| [ON] | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 감쇠</nobr>| [0.05] (0 ~ 1) | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 드래그</nobr>| [0.15] (0 ~ 1) | 
| └─<img src="/images/icon/ic_check_off.png" alt="check off icon"/> (Ignore Limit)</nobr>| [OFF] | 조인트 제한을 무시하여 제약 조건을 더욱 줄이기
| <img src="/images/icon/ic_tune.png" alt="tune icon"/> <b>각운동</b></nobr>| | Settings for angular motion
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 단단함</nobr>| [0] (-1 ~ 1) | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 주 동력</nobr>| [5] (0 ~ 8) | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/>  두 번째 동력</nobr>| [5] (0 ~ 8) | 
| ├─<img src="/images/icon/ic_toggle_on.png" alt="toggle on icon"/> 목표 위치</nobr>| 제로 | 제로, 센터, 최소, 최대, 
| ├─<img src="/images/icon/ic_check_off.png" alt="check off icon"/> 가능할 때 잠금</nobr>| [OFF] | 
| ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 가속 모드</nobr>| [ON] | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 감쇠</nobr>| [0.05] (0 ~ 1) | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 드래그</nobr>| [0.15] (0 ~ 1) | 
| └─<img src="/images/icon/ic_check_off.png" alt="check off icon"/> (Ignore Limit)</nobr>| [OFF] | 조인트 제한을 무시하여 제약 조건을 더욱 줄이기
| <img src="/images/icon/ic_tune.png" alt="tune icon"/> <b>옵션</b></nobr>| | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 최소 드래그</nobr>| [0] (0 ~ 1) | 자동 모드에서의 최소 드래그 값
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 드래그 비율</nobr>| [1] (0 ~ 5) | 자동 모드에서 드래그 값에 적용되는 비율
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 최소 질량</nobr>| [0] (0 ~ 1) | 자동 모드에서의 최소 질량 값
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 질량 비율</nobr>| [1] (0 ~ 10) | 자동 모드에서 질량 값에 적용되는 비율
| ├─<img src="/images/icon/ic_toggle_on.png" alt="toggle on icon"/> 질량 중심</nobr>| 제로 | 자동, 제로, <br/>질량 중심을 제로로 설정하거나 각 충돌체의 위치와 크기에 따라 자동 설정
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 투영 거리</nobr>| [0.05] (0 ~ 0.1) | 물체 간의 중립상태에 대한 거리 이 값 초과 시 조인트를 강제로 초기화
| └─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 투영 각도</nobr>| [5] (0 ~ 60) | 물체 간의 중립상태에 대한 각도가 이 값 초과 시 조인트를 강제로 초기화
| <img src="/images/icon/ic_slider.png" alt="slider icon"/> 자동 리셋 임계값</nobr>| [35] (0 ~ 100) | 속도가 이 값을 초과할 때 뼈와 그 자식 뼈를 자동으로 리셋
| <img src="/images/icon/ic_tune.png" alt="tune icon"/> <b>자동 재설정</b></nobr>| | 
| └─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 임계값</nobr>| [30] (0 ~ 50) | 
| <img src="/images/icon/ic_check_on.png" alt="check on icon"/> <b>신체 콜라이더</b></nobr>| | 
| ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 활성화</nobr>| [ON] | 
...
| <img src="/images/icon/ic_check_on.png" alt="check on icon"/> <b>가슴 물리</b><sup>[PRO]</sup></nobr>| | 
| ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 활성화</nobr>| [ON] | 
| ├─ 뼈 선택</nobr>|| 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 스프링 힘</nobr>| [1.5] (0 ~ 5) | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 감쇠</nobr>| [0.1] (0 ~ 1) | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 질량</nobr>| [0.1] (0 ~ 1) | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 드래그</nobr>| [0.1] (0 ~ 10) | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 중력 반대</nobr>| [10] (0 ~ 45) | 
| ├─<img src="/images/icon/ic_tune.png" alt="tune icon"/> <b>회전 제한</b></nobr>| | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 상한</nobr>| [100] (0 ~ 120) | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 하한</nobr>| [15] (0 ~ 45) | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 좌측 / 우측 제한</nobr>| [15] (0 ~ 45) | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 스프링 힘</nobr>| [1.25] (0 ~ 10) | 제한을 초과할 때 스프링 힘
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 감쇠</nobr>| [1] (0 ~ 1) | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 접촉 거리</nobr>| [0.5] (0 ~ 1) | 
| │ └─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 바운스</nobr>| [0.2] (0 ~ 1) | 
...
| ├─<img src="/images/icon/ic_tune.png" alt="tune icon"/> <b>센터</b></nobr>| | 
...
| ├─<img src="/images/icon/ic_tune.png" alt="tune icon"/> <b>충돌</b></nobr>| | 
| │ ├─<img src="/images/icon/ic_check_off.png" alt="check off icon"/> 팔과 충돌</nobr>| [OFF] | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 콜라이더 반지름</nobr>| [0.07] (0 ~ 0.1) | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 콜라이더 길이</nobr>| [0.65] (0 ~ 1) | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 콜라이더 곡선</nobr>| [2] (-2 ~ 2) | 천 시뮬레이션과 함께 작동합니다.
| │ ├─<img src="/images/icon/ic_check_off.png" alt="check off icon"/> 시각화</nobr>| [OFF] | 
| │ ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 유두 활성화</nobr>| [ON] | 천 시뮬레이션과 함께 작동합니다.
| │ ├─<img src="/images/icon/ic_tune.png" alt="tune icon"/> <b>유두 위치</b></nobr>| | 
...
| │ └─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 유두 크기</nobr>| [0.1] (0 ~ 1) | 
...
| ├─<img src="/images/icon/ic_check_off.png" alt="check off icon"/> 소프트바디 전용</nobr>| [OFF] | 물리 조인트를 비활성화하고 소프트바디 입자만 사용합니다.
| └─<img src="/images/icon/ic_list.png" alt="list icon"/> 프리셋</nobr>| **기본값 (초기화)** | 기본값 (초기화), (Preset 1), (Preset 2), (Preset 3), (tina), (预设1), (预设2),  |
| <img src="/images/icon/ic_check_on.png" alt="check on icon"/> <b>스커트 물리</b><sup>[PRO]</sup></nobr>| | 
| ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 활성화</nobr>| [ON] | 
| ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 입자 역학 사용</nobr>| [ON] | 
| ├─<img src="/images/icon/ic_tune.png" alt="tune icon"/> <b>시뮬레이션 설정</b></nobr>| | 
| │ ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 전역 사용</nobr>| [ON] | Pro / Cloth Simulation 아래에서 전역 설정 찾기
| │ ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 드래그 활성화</nobr>| [ON] | 
| │ ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 시뮬레이트</nobr>| [ON] | 
...
| ├─ <b>기본 그룹</b></nobr>|| 
| ├─ 뼈 선택</nobr>|| 
| ├─<img src="/images/icon/ic_chevron.png" alt="chevron icon"/> 정렬</nobr>| **최단 경로** | 최단 경로, 원형, 선형, 정렬 없음, <br/>측면 연결을 만들 때 사용되는 정렬 방법을 설정합니다. |
| ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 폐쇄 루프</nobr>| [ON] | 각 레벨의 폐쇄 루프에 대한 본들
...
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 측면 순응도</nobr>| [1] (0 ~ 1) | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 측면 앵커</nobr>| [0] (0 ~ 0.5) | 
| │ ├─<img src="/images/icon/ic_check_off.png" alt="check off icon"/> 시각화</nobr>| [OFF] | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 최대 각속도</nobr>| [2] (0 ~ 4) | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 관성</nobr>| [2] (1 ~ 5) | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 부드럽게 만들기</nobr>| [0] (0 ~ 1) | 입자 제약을 부드럽게 만듭니다.
...
| ├─<img src="/images/icon/ic_tune.png" alt="tune icon"/> <b>물리 속성</b></nobr>| | Physics properties like mass, drag and friction
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 질량</nobr>| [0.1] (0 ~ 1) | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 드래그</nobr>| [0] (0 ~ 10) | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 수평 겹침</nobr>| [-0.2] (-1 ~ 1) | 수평으로 충돌체의 겹침
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 질량 분포</nobr>| [0] (-1 ~ 1) | 각 레벨에서 질량 줄이기
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 마찰</nobr>| [0] (0 ~ 1) | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 해결기 반복 횟수</nobr>| [20] (1 ~ 150) | 충돌 해결 시 반복 횟수
| │ └─<img src="/images/icon/ic_toggle_on.png" alt="toggle on icon"/> 질량 중심</nobr>| 제로 | 자동, 제로, <br/>질량 중심을 제로로 설정하거나 각 충돌체의 위치와 크기에 따라 자동 설정
| ├─<img src="/images/icon/ic_tune.png" alt="tune icon"/> <b>부모-자식 조인트</b></nobr>| | 
| │ ├─<img src="/images/icon/ic_check_off.png" alt="check off icon"/> 시각화</nobr>| [OFF] | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 스윙 드라이브</nobr>| [0] (0 ~ 10) | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 트위스트 드라이브</nobr>| [5] (0 ~ 10) | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 드라이브 댐핑</nobr>| [0.01] (0 ~ 1) | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 감소 비율</nobr>| [0.5] (0 ~ 1) | 
| │ └─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 앵커 위치</nobr>| [0] (0 ~ 1) | 조인트 생성 시 앵커 위치 선택. 0 = 부모 본에 앵커, 1 = 자식 본에 앵커
| ├─<img src="/images/icon/ic_tune.png" alt="tune icon"/> <b>측면 조인트</b></nobr>| | 
| │ ├─<img src="/images/icon/ic_check_off.png" alt="check off icon"/> 시각화</nobr>| [OFF] | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 선형운전</nobr>| [5] (0 ~ 10) | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 각운전</nobr>| [0] (0 ~ 10) | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 드라이브 댐핑</nobr>| [0.1] (0 ~ 1) | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 감소 비율</nobr>| [1] (0 ~ 1) | 
| │ ├─<img src="/images/icon/ic_check_off.png" alt="check off icon"/> Y 잠금</nobr>| [OFF] | 
| │ └─<img src="/images/icon/ic_check_off.png" alt="check off icon"/> Z 잠금</nobr>| [OFF] | 
| ├─<img src="/images/icon/ic_tune.png" alt="tune icon"/> <b>충돌체</b></nobr>| | 
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 콜라이더 반지름</nobr>| [0.01] (0 ~ 0.1) | 
| │ ├─<img src="/images/icon/ic_chevron.png" alt="chevron icon"/> 충돌체 유형</nobr>| **상자** | 상자, 캡슐, 구,  |
| │ ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 콜라이더 길이</nobr>| [0.8] (0 ~ 1) | 몸체 충돌체의 간섭을 피하기 위해 첫 번째 레벨의 충돌체 길이를 줄입니다.
| │ └─<img src="/images/icon/ic_slider.png" alt="slider icon"/> (First Collider Length)</nobr>| [0.5] (0 ~ 1) | 몸체 충돌체의 간섭을 피하기 위해 첫 번째 레벨의 충돌체 길이를 줄입니다.
...
| │ │ └─<img src="/images/icon/ic_slider.png" alt="slider icon"/> (First Collider Length)</nobr>| [0.5] (0 ~ 1) | 몸체 충돌체의 간섭을 피하기 위해 첫 번째 레벨의 충돌체 길이를 줄입니다.
| │ └─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 기본 그룹 설정 사용</nobr>| [ON] | 
| └─<img src="/images/icon/ic_list.png" alt="list icon"/> 프리셋</nobr>| **기본값 (초기화)** | 기본값 (초기화), (hurrah), (nyotengu cheongsam), (nyo birthday), (Preset 1), (Preset 2), (Preset 3), (Preset 4), (Preset 5), (Preset 6), (预设1),  |
| <img src="/images/icon/ic_check_on.png" alt="check on icon"/> <b>헤어 물리</b></nobr>| | 
| ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 활성화</nobr>| [ON] | 
| ├─ 뼈 선택</nobr>|| 본 선택
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 첫 X 본 건너뛰기</nobr>| [0] (0 ~ 5) | 첫 X 개 레벨에 대해 물리 연결을 생성하지 않음
...
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 스프링</nobr>| [1.25] (0 ~ 5) | 
...
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 질량</nobr>| [0.01] (0 ~ 0.1) | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 드래그</nobr>| [1] (0 ~ 10) | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 콜라이더 반지름</nobr>| [0.005] (0 ~ 0.05) | 충돌 해결 시 사용되는 입자의 크기
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 콜라이더 길이</nobr>| [0.9] (0 ~ 1) | 
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 앵커 위치</nobr>| [0] (0 ~ 1) | 조인트 생성 시 앵커 위치 선택. 0 = 부모 본에 앵커, 1 = 자식 본에 앵커
| └─<img src="/images/icon/ic_list.png" alt="list icon"/> 프리셋</nobr>| **기본값 (초기화)** | 기본값 (초기화), (momiji bob), (Preset 1),  |
| <img src="/images/icon/ic_check_on.png" alt="check on icon"/> <b>드리블 물리</b></nobr>| | 
| ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 활성화</nobr>| [ON] | 
| ├─ 뼈 선택</nobr>|| 본 선택
| ├─<img src="/images/icon/ic_slider.png" alt="slider icon"/> 첫 X 본 건너뛰기</nobr>| [0] (0 ~ 5) | 첫 X 개 레벨에 대해 물리 연결을 생성하지 않음
| ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> <b>입자 동역학</b></nobr>| | 
...
| <img src="/images/icon/ic_check_on.png" alt="check on icon"/> <b>객체 분리</b></nobr>| | 
| ├─<img src="/images/icon/ic_check_on.png" alt="check on icon"/> 활성화</nobr>| [ON] | 
| ├─ 뼈 선택</nobr>|| 
