...
| ├─ ☑ 동적 포함| [ON] | 
| └─ ☑ 동적 배타| [ON] | 
|  ⚙️ **선형이동**| | Settings for linear movements
| ├─ ☑ 제약| 자동 | 자동, 제한됨, 잠김, 자유, 
| ├─ ☑ 0 제한 고정| [ON] | 
| ├─ ⊖ 최소 스프링 힘| [5] (0 ~ 15) | 
| ├─ ⊖ 최대 제한| [0.05] (0.05 ~ 0.1) | 
...
| ├─ ⊖ 감쇠| [0.05] (0 ~ 1) | 
| └─ ⊖ 드래그| [0.15] (0 ~ 1) | 
|  ⚙️ **각이동**| | Settings for angular movements
| ├─ ☑ 제약| 자동 | 자동, 제한됨, 잠김, 자유, 
| ├─ ☑ 0 제한 고정| [ON] | 
| ├─ ⊖ 최소 스프링 힘| [5] (0 ~ 15) | 
| ├─ ⊖ 최대 제한| [90] (3 ~ 90) | 
...
| ├─ ⊖ 스프링 힘| [0.1] (0 ~ 5) | 
| └─ ⊖ 감쇠| [0.1] (0 ~ 1) | 
|  ⚙️ **선형운동**| | Settings for linear motion
| ├─ ⊖ 단단함| [0] (-1 ~ 1) | 
| ├─ ⊖ 주 동력| [5] (0 ~ 8) | 
| ├─ ⊖  두 번째 동력| [3] (0 ~ 8) | 
...
|  ⚙️ **각운동**| | Settings for angular motion
| ├─ ⊖ 단단함| [0] (-1 ~ 1) | 
| ├─ ⊖ 주 동력| [5] (0 ~ 8) | 
| ├─ ⊖  두 번째 동력| [5] (0 ~ 8) | 
| ├─ ☑ 목표 위치| 제로 | 제로, 센터, 최소, 최대, 
...
| │  ├─ ☑ 발| [ON] | 
| │  └─ ☑ 플레이어| [ON] | 
| ├─ ⚙️ **물리 속성**| | Physics properties like mass, drag and friction
| │ ├─ ⊖ 질량| [0.1] (0 ~ 1) | 
| │ ├─ ⊖ 드래그| [0] (0 ~ 10) | 
