...
|<nobr>│&nbsp;│&nbsp;└&nbsp;![slider icon](/images/icon/ic_slider.png) (First Collider Length)</nobr>| [0.5] (0 ~ 1) | 몸체 충돌체의 간섭을 피하기 위해 첫 번째 레벨의 충돌체 길이를 줄입니다.
|<nobr>│&nbsp;└&nbsp;![check_on icon](/images/icon/ic_check_on.png) 기본 그룹 설정 사용</nobr>| [ON] | 
|<nobr>└&nbsp;![list icon](/images/icon/ic_list.png) 프리셋</nobr>| **기본값 (초기화)** | 기본값 (초기화), (hurrah), (nyotengu cheongsam), (nyo birthday), (Preset 1), (Preset 2), (Preset 3), (Preset 4), (Preset 5), (Preset 6), (预设1),  |
|<nobr>![check_on icon](/images/icon/ic_check_on.png) <b>헤어 물리</b></nobr>| | 
|<nobr>├&nbsp;![check_on icon](/images/icon/ic_check_on.png) 활성화</nobr>| [ON] | 
|<nobr>├&nbsp; 뼈 선택</nobr>|| 본 선택
|<nobr>├&nbsp;![slider icon](/images/icon/ic_slider.png) 첫 X 본 건너뛰기</nobr>| [0] (0 ~ 5) | 첫 X 개 레벨에 대해 물리 연결을 생성하지 않음
...
|<nobr>![check_on icon](/images/icon/ic_check_on.png) <b>드리블 물리</b></nobr>| | 
|<nobr>├&nbsp;![check_on icon](/images/icon/ic_check_on.png) 활성화</nobr>| [ON] | 
|<nobr>├&nbsp; 뼈 선택</nobr>|| 본 선택
|<nobr>├&nbsp;![slider icon](/images/icon/ic_slider.png) 첫 X 본 건너뛰기</nobr>| [0] (0 ~ 5) | 첫 X 개 레벨에 대해 물리 연결을 생성하지 않음
|<nobr>├&nbsp;![check_on icon](/images/icon/ic_check_on.png) <b>입자 동역학</b></nobr>| | 
...
|<nobr>![check_on icon](/images/icon/ic_check_on.png) <b>객체 분리</b></nobr>| | 
|<nobr>├&nbsp;![check_on icon](/images/icon/ic_check_on.png) 활성화</nobr>| [ON] | 
|<nobr>├&nbsp; 뼈 선택</nobr>|| 
