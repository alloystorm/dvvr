...
| :--- | --- | :--- |
|<nobr>![radio_on icon](/images/icon/ic_radio_on.png) [フリーフライカメラ]</nobr>|| 
|<nobr>└&nbsp;![setting icon](/images/icon/ic_setting.png) <b>[フリーフライカメラ]</b></nobr>| | 
...
|<nobr>![radio_off icon](/images/icon/ic_radio_off.png) [オービットカム]</nobr>|| 
|<nobr>└&nbsp;![setting icon](/images/icon/ic_setting.png) <b>[オービットカム]</b></nobr>| | 
|<nobr>&nbsp;&nbsp;├&nbsp;![chevron icon](/images/icon/ic_chevron.png) ターゲット選択</nobr>| **自動** | 自動, 選択されました, グループ, 回転, 回転 + グループ, ステージセンター,  |
|<nobr>&nbsp;&nbsp;├&nbsp;![chevron icon](/images/icon/ic_chevron.png) トラッキングモード</nobr>| **センター** | センター, 頭, 胸,  |
|<nobr>&nbsp;&nbsp;├&nbsp;![slider icon](/images/icon/ic_slider.png) ターゲットスムージング</nobr>| [0.5] (0 ~ 2) | 
|<nobr>&nbsp;&nbsp;├&nbsp;![slider icon](/images/icon/ic_slider.png) 予測</nobr>| [1] (0 ~ 2) | スムージングによる遅延を減少させるため、ターゲットの位置を予測
...
|<nobr>![radio_off icon](/images/icon/ic_radio_off.png) [オートカム]</nobr>|| 
|<nobr>└&nbsp;![setting icon](/images/icon/ic_setting.png) <b>[オートカム]</b></nobr>| | 
|<nobr>&nbsp;&nbsp;├&nbsp;![chevron icon](/images/icon/ic_chevron.png) ターゲット選択</nobr>| **自動** | 自動, 選択されました, グループ, 回転, 回転 + グループ, ステージセンター,  |
|<nobr>&nbsp;&nbsp;├&nbsp;![chevron icon](/images/icon/ic_chevron.png) トラッキングモード</nobr>| **センター** | センター, 頭, 胸,  |
|<nobr>&nbsp;&nbsp;├&nbsp;![slider icon](/images/icon/ic_slider.png) ターゲットスムージング</nobr>| [0.5] (0 ~ 2) | 
|<nobr>&nbsp;&nbsp;├&nbsp;![slider icon](/images/icon/ic_slider.png) 予測</nobr>| [1] (0 ~ 2) | スムージングによる遅延を減少させるため、ターゲットの位置を予測
...
|<nobr>&nbsp;&nbsp;└&nbsp;![list icon](/images/icon/ic_list.png) プリセット</nobr>| **デフォルト（リセット）** | デフォルト（リセット）, (Preset 1),  |
|<nobr>![radio_off icon](/images/icon/ic_radio_off.png) [長回し]</nobr>|| 
|<nobr>└&nbsp;![setting icon](/images/icon/ic_setting.png) <b>[長回し]</b></nobr>| | 
|<nobr>&nbsp;&nbsp;├&nbsp;![chevron icon](/images/icon/ic_chevron.png) ターゲット選択</nobr>| **自動** | 自動, 選択されました, グループ, 回転, 回転 + グループ, ステージセンター,  |
|<nobr>&nbsp;&nbsp;├&nbsp;![chevron icon](/images/icon/ic_chevron.png) トラッキングモード</nobr>| **センター** | センター, 頭, 胸,  |
|<nobr>&nbsp;&nbsp;├&nbsp;![slider icon](/images/icon/ic_slider.png) ターゲットスムージング</nobr>| [0.5] (0 ~ 2) | 
|<nobr>&nbsp;&nbsp;├&nbsp;![slider icon](/images/icon/ic_slider.png) 予測</nobr>| [1] (0 ~ 2) | スムージングによる遅延を減少させるため、ターゲットの位置を予測
...
|<nobr>![radio_off icon](/images/icon/ic_radio_off.png) [第一人称]</nobr>|| 
|<nobr>└&nbsp;![setting icon](/images/icon/ic_setting.png) <b>[第一人称]</b></nobr>| | 
...
|<nobr>&nbsp;&nbsp;└&nbsp; 中心に戻す</nobr>|| 
|<nobr>![radio_off icon](/images/icon/ic_radio_off.png) [固定カメラ]</nobr>|| 
|<nobr>└&nbsp;![setting icon](/images/icon/ic_setting.png) <b>[固定カメラ]</b></nobr>| | 
|<nobr>&nbsp;&nbsp;├&nbsp;![chevron icon](/images/icon/ic_chevron.png) ターゲット選択</nobr>| **自動** | 自動, 選択されました, グループ, 回転, 回転 + グループ, ステージセンター,  |
|<nobr>&nbsp;&nbsp;├&nbsp;![chevron icon](/images/icon/ic_chevron.png) トラッキングモード</nobr>| **センター** | センター, 頭, 胸,  |
|<nobr>&nbsp;&nbsp;├&nbsp;![slider icon](/images/icon/ic_slider.png) ターゲットスムージング</nobr>| [0.5] (0 ~ 2) | 
|<nobr>&nbsp;&nbsp;├&nbsp;![slider icon](/images/icon/ic_slider.png) 予測</nobr>| [1] (0 ~ 2) | スムージングによる遅延を減少させるため、ターゲットの位置を予測
