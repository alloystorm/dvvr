...
|- ノイズ除去半径 | [8] (1 ~ 32) | 
|- シャドウディマー | [1] (0 ~ 1) | シャドウの強度を減少させる。
| プリセット | **スポットライト**, ポイントライト, エリアライト, ピラミッドプロジェクター近, ピラミッドプロジェクター遠, ボックスプロジェクター近, ボックスプロジェクター遠, スポットライトアレイ, サスペンドスポットライト,  |  |
...
| プリセット | 夕焼け, **日中**, ウィンドウ, ステージ, シルエット, プロジェクター, エリアライト, ポイントライトアレイ,  |  |
