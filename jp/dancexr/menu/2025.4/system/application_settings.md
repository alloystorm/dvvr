...
| :--- | --- | :--- |
|<nobr>![check_off icon](/images/icon/ic_check_off.png) 前のシーンを読み込む</nobr>| [OFF] | 起動時に最後のシーンを自動的に読み込む
|<nobr>![check_on icon](/images/icon/ic_check_on.png) VRでデスクトップウィンドウをブロック</nobr>| [ON] | VRモードでデスクトップウィンドウをブロック
|<nobr>![check_off icon](/images/icon/ic_check_off.png) セーブからタグを復元</nobr>| [OFF] | コンテンツキャッシュが再構築または破損した場合に、保存された設定からタグを復元しようとします
|<nobr>![check_on icon](/images/icon/ic_check_on.png) 圧縮DDSの反転</nobr>| [ON] | 圧縮DDSテクスチャを反転
|<nobr>![check_off icon](/images/icon/ic_check_off.png) 非圧縮DDSの反転</nobr>| [OFF] | 非圧縮DDSテクスチャを反転
|<nobr>![hand icon](/images/icon/ic_hand.png) <b>VR ハンズ</b></nobr>| | 
|<nobr>├&nbsp;![check_on icon](/images/icon/ic_check_on.png) 手の表示</nobr>| [ON] | 
...
|<nobr>├&nbsp;![tune icon](/images/icon/ic_tune.png) <b>手の向き</b></nobr>| | 
|<nobr>│&nbsp;├&nbsp; <b>オフセット</b></nobr>|| 
...
|<nobr>│&nbsp;├&nbsp;![slider icon](/images/icon/ic_slider.png) 回転</nobr>| [45] (-90 ~ 90) | 
|<nobr>│&nbsp;└&nbsp; ポインターを更新</nobr>|| 
|<nobr>├&nbsp;![chevron icon](/images/icon/ic_chevron.png) 左手のポーズ</nobr>| **自動** | 自動, (Palm Fingers Apart), (Palm Fingers Together), (Fist), (Victory), (Okay), (Hold), (Vulcan), (Horn), ポイント, (Middle Finger), (Thumb Up), (Grab),  |
|<nobr>├&nbsp;![check_off icon](/images/icon/ic_check_off.png) <b>左手アクセサリー</b></nobr>| | 
...
|<nobr>├&nbsp;![chevron icon](/images/icon/ic_chevron.png) 右手のポーズ</nobr>| **自動** | 自動, (Palm Fingers Apart), (Palm Fingers Together), (Fist), (Victory), (Okay), (Hold), (Vulcan), (Horn), ポイント, (Middle Finger), (Thumb Up), (Grab),  |
|<nobr>└&nbsp;![check_off icon](/images/icon/ic_check_off.png) <b>右手アクセサリー</b></nobr>| | 
|<nobr>&nbsp;&nbsp;├&nbsp;![check_off icon](/images/icon/ic_check_off.png) 有効にする</nobr>| [OFF] | 
|<nobr>&nbsp;&nbsp;├&nbsp;![chevron icon](/images/icon/ic_chevron.png) モデル</nobr>| **[ポール]** | [ポール],  |
|<nobr>&nbsp;&nbsp;├&nbsp;![tune icon](/images/icon/ic_tune.png) <b>アンカーオフセット</b></nobr>| | Set the anchor position for the attachment to attach to
|<nobr>&nbsp;&nbsp;│&nbsp;├&nbsp; <b>位置</b></nobr>|| 
...
|<nobr>&nbsp;&nbsp;├&nbsp;![check_on icon](/images/icon/ic_check_on.png) グラブポーズ</nobr>| [ON] | 取り付けにいるときに手のポーズを自動的にグラブに変更
|<nobr>&nbsp;&nbsp;└&nbsp;![slider icon](/images/icon/ic_slider.png) 手の動き</nobr>| [0] (-1 ~ 1) | 取り付けモーションに対して手を移動
|<nobr>![chevron icon](/images/icon/ic_chevron.png) ギズモ第3軸</nobr>| **回転** | 回転, 深度,  |
|<nobr>![check_on icon](/images/icon/ic_check_on.png) 翻訳された名前を使用</nobr>| [ON] | 
