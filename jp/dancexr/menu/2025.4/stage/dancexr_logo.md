...
|<nobr>![texture icon](/images/icon/ic_texture.png) <b>ロゴサーフェス1</b></nobr>| | 
...
|<nobr>└&nbsp;![list icon](/images/icon/ic_list.png) プリセット</nobr>| **ホワイトグロス** | ホワイトグロス, レッドグロス, クローム, ブラックグロス, ゴールド, ソリッドグラス, 薄いガラス,  |
|<nobr>![texture icon](/images/icon/ic_texture.png) <b>ロゴサーフェス2</b></nobr>| | 
|<nobr>├&nbsp;![slider icon](/images/icon/ic_slider.png) グロス</nobr>| [0.9] (0 ~ 1) | 
|<nobr>├&nbsp;![slider icon](/images/icon/ic_slider.png) 金属的</nobr>| [0] (0 ~ 1) | 
|<nobr>├&nbsp;![slider icon](/images/icon/ic_slider.png) バンプ</nobr>| [0.2] (0 ~ 1) | 
|<nobr>├&nbsp;![slider icon](/images/icon/ic_slider.png) グロー</nobr>| [0] (0 ~ 10) | 
...
|<nobr>│&nbsp;├&nbsp;![chevron icon](/images/icon/ic_chevron.png) ブレンドモード</nobr>| **ブレンド** | オリジナル, (Multiply), ブレンド, (Color Shift),  |
|<nobr>│&nbsp;├&nbsp;![slider icon](/images/icon/ic_slider.png) ブレンド</nobr>| [1] (0 ~ 1) | 
|<nobr>│&nbsp;└&nbsp;![list icon](/images/icon/ic_list.png) プリセット</nobr>| **赤** | オリジナル, 白, 黒, 赤, (Yellow), (Dark Gray), 青, 肌, (Gray), (Orange),  |
|<nobr>├&nbsp;![check_off icon](/images/icon/ic_check_off.png) <b>トゥーンシェーダー</b></nobr>| | 
|<nobr>│&nbsp;├&nbsp;![check_off icon](/images/icon/ic_check_off.png) 有効にする</nobr>| [OFF] | 
|<nobr>│&nbsp;├&nbsp;![slider icon](/images/icon/ic_slider.png) シェーディング</nobr>| [1] (0 ~ 1) | 
|<nobr>│&nbsp;├&nbsp;![slider icon](/images/icon/ic_slider.png) アウトライン</nobr>| [0.5] (0 ~ 1) | 
...
|<nobr>│&nbsp;├&nbsp;![slider icon](/images/icon/ic_slider.png) 屈折</nobr>| [0.5] (1 ~ 3) | 
|<nobr>│&nbsp;└&nbsp;![slider icon](/images/icon/ic_slider.png) 厚さ</nobr>| [1] (0 ~ 1) | 
|<nobr>└&nbsp;![list icon](/images/icon/ic_list.png) プリセット</nobr>| **レッドグロス** | ホワイトグロス, レッドグロス, クローム, ブラックグロス, ゴールド, ソリッドグラス, 薄いガラス,  |
|<nobr>![check_on icon](/images/icon/ic_check_on.png) ダイヤモンド</nobr>| [ON] | 
|<nobr>![texture icon](/images/icon/ic_texture.png) <b>ダイヤモンドサーフェス</b></nobr>| | 
|<nobr>├&nbsp;![slider icon](/images/icon/ic_slider.png) グロス</nobr>| [0.9] (0 ~ 1) | 
...
|<nobr>![slider icon](/images/icon/ic_slider.png) 距離</nobr>| [4.5] (1 ~ 8) | 
|<nobr>![slider icon](/images/icon/ic_slider.png) 位置</nobr>| [0] (-180 ~ 180) | 
