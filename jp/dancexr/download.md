...
毎月のリリースを、SteamやAmazonなど他のすべてのプラットフォームより早く入手できます。
...
<div class="editions-grid" style="grid-template-columns: repeat(3, 1fr);">
  ...
  <div class="edition-card">
    ...
    <ul class="edition-features">
      <li>Proの全特典</li>
      <li>クリエイターエディション — オフラインレンダリング</li>
...
<div class="editions-grid" style="grid-template-columns: repeat(3, 1fr);">
  ...
  <div class="edition-card">
    ...
    <p class="edition-name">無料版</p>
    <p class="edition-price">無料</p>
    <div class="edition-divider"></div>
    <ul class="edition-features">
      <li>PMX / XPSモデルを読み込む</li>
      <li>VMD / BVHモーションを再生</li>
      <li>全環境システム</li>
...
<div class="editions-grid" style="grid-template-columns: repeat(3, 1fr);">
  ...
  <div class="edition-card">
    ...
    <p class="edition-price">Itch.io経由</p>
    <div class="edition-divider"></div>
    <ul class="edition-features">
      <li>Questハードウェアでの完全VR体験</li>
      <li>スタンドアロン — PC不要</li>
