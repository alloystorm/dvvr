...
|**Body Paint** | | 
|- Paint Side | **Both**, Front, Back,  | 
| Texture | **[None]**, [Tattoo],  |  |
|- Brush Size | [0.2] (0 ~ 1) | 
|- Brush Rotation | [0] (-180 ~ 180) | 
|- Brush Type | **Base**, Pattern, Edge, Erase,  | 
| Erase | OFF | 
|**Color** | | 
|- Color Mode | **RGB**, HSV,  | 
|- Hue | [0] (0 ~ 1) | 
...
|- Pattern Type | **None**, Grid, Maze, Maze Curve, Parallel,  | 
...
| Topology | Adaptive Hexagon, Adaptive Rectangle, **Horizontal Layout**, Horizontal Strings, Vertical Layout, Vertical Strings,  |  |
...
| UV Mapping | Circular, **Mirror Scaled**, Mirror Actual, Wrap Scaled, Wrap Actual,  |  |
|**Anchor** | | 
|- Top Layers | [2] (0 ~ 10) | 
|**Top Anchor** | | 
|- Anchor Selection | [1] (0 ~ 1) | 
|- Selection Offset | [0.5] (0 ~ 1) | 
| Anchor Bone | Waist, **Torso**, Hip, Head, Thighs, Shins, Upper Arms, Lower Arms, Hands, Boobs,  |  |
| Lock Mode | **None**, Lock, Lock Height, Sticky,  |  |
| Anchor Positoin || 
|- X | [0] (-0.5 ~ 0.5) | 
|- Y | [0.2] (-0.5 ~ 0.5) | 
|- Z | [0] (-0.5 ~ 0.5) | 
