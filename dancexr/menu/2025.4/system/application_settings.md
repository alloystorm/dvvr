...
| :--- | --- | :--- |
|<nobr>Load Previous Scene</nobr>| [OFF] | Automatically load the last scene on start
|<nobr>Block desktop window in VR</nobr>| [ON] | Blocks desktop window in VR mode
...
|<nobr>&nbsp;&nbsp;├&nbsp;Grab Pose</nobr>| [ON] | Automatically change hand pose to grab when they are on the attachment
|<nobr>&nbsp;&nbsp;└&nbsp;Hand Motion</nobr>| [0] (-1 ~ 1) | Move hands relative to the attachment motion
|<nobr>Gizmo 3rd Axis</nobr>| **Rotation** | Rotation, Depth,  |
|<nobr>Use Translated Names</nobr>| [ON] | 
