...
* bundles: [Saved scene along with all the necessary assets](features/scene_bundle) included in a zip package.
...
* videos: Videos that can be used for [projection and dynamic texture map](features/video_player). Supports MP4 format only.
