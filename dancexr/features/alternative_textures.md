...
When the user select one of the alternative textures, the new textures will be loaded and replace the default ones that are used by the model. Selecting alternative textures also automatically updates the texture menu to reflect the currently active textures used for the material.
