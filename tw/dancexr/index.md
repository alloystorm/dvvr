...
[可在 Patreon 上獲取 →](download){: .btn-ghost}
...
<div class="editions-grid" style="grid-template-columns: repeat(3, 1fr);">
  ...
  <div class="edition-card">
    ...
    <a href="download" class="edition-cta">免費下載</a>
  </div>
  ...
  <div class="edition-card featured">
    ...
    <a href="download" class="edition-cta">立即購買</a>
  </div>
...
<div class="editions-header" markdown="1">
  DanceXR 同樣支援 Android、iOS 和 Quest VR —— 相同的核心功能，針對您的裝置進行了最佳化。詳情請查看[下載頁面](download)。
</div>
</section>
...
<div class="release-card">
  ...
  <div class="release-items">
    <div class="release-item">載入時自動設定物理</div>
    <div class="release-item">更平滑的擺姿與關節限制</div>
    <div class="release-item">更穩定的手部抓握</div>
    <div class="release-item">原生路徑追蹤應用公開預覽</div>
  </div>
  <a href="releases/2026.8" class="btn-ghost">完整版本說明</a>
</div>
</div>
</section>
