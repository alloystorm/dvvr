...
| :--- | --- | :--- |
|<nobr> ![check_off icon](/images/icon/ic_check_off.png)  載入上個場景</nobr>| [OFF] | 啟動時自動加載上個場景
|<nobr> ![check_on icon](/images/icon/ic_check_on.png)  在 VR 中阻止桌面窗口</nobr>| [ON] | 在 VR 模式下阻止桌面窗口
|<nobr> ![check_off icon](/images/icon/ic_check_off.png)  從保存中恢復標籤</nobr>| [OFF] | 嘗試從保存的設置中恢復標籤，以防你的內容緩存被重建或損壞
|<nobr> ![check_on icon](/images/icon/ic_check_on.png)  翻轉 DDS 壓縮</nobr>| [ON] | 翻轉壓縮的 DDS 資源
|<nobr> ![check_off icon](/images/icon/ic_check_off.png)  翻轉 DDS 解壓縮</nobr>| [OFF] | 翻轉未壓縮的 DDS 資源
|<nobr> ![hand icon](/images/icon/ic_hand.png)  <b>虛擬現實手部</b></nobr>| | 
|<nobr>├&nbsp; ![check_on icon](/images/icon/ic_check_on.png)  手部可見</nobr>| [ON] | 
...
|<nobr>│&nbsp;├&nbsp; ![slider icon](/images/icon/ic_slider.png)  旋轉</nobr>| [45] (-90 ~ 90) | 
|<nobr>│&nbsp;└&nbsp; 更新指標</nobr>|| 
|<nobr>├&nbsp; ![chevron icon](/images/icon/ic_chevron.png)  左手姿勢</nobr>| **自動** | 自動, (Palm Fingers Apart), (Palm Fingers Together), (Fist), (Victory), (Okay), (Hold), (Vulcan), (Horn), 點, (Middle Finger), (Thumb Up), (Grab),  |
...
|<nobr>├&nbsp; ![chevron icon](/images/icon/ic_chevron.png)  右手姿勢</nobr>| **自動** | 自動, (Palm Fingers Apart), (Palm Fingers Together), (Fist), (Victory), (Okay), (Hold), (Vulcan), (Horn), 點, (Middle Finger), (Thumb Up), (Grab),  |
...
|<nobr>&nbsp;&nbsp;├&nbsp; ![check_on icon](/images/icon/ic_check_on.png)  抓取姿勢</nobr>| [ON] | 當手在附加物上時，自動改變手部姿勢為抓取
|<nobr>&nbsp;&nbsp;└&nbsp; ![slider icon](/images/icon/ic_slider.png)  手部運動</nobr>| [0] (-1 ~ 1) | 相對於附加物運動移動手部
|<nobr> ![chevron icon](/images/icon/ic_chevron.png)  Gizmo 第三軸</nobr>| **旋轉** | 旋轉, 深度,  |
|<nobr> ![check_on icon](/images/icon/ic_check_on.png)  使用翻譯名稱</nobr>| [ON] | 
